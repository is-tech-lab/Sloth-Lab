...
Sloth Feed は、**「人をダメにする」を旗印とする動的IP プロダクト**である。「ダメ=仕事ではないこと」と定義し、AI ナマケモノが Larry Wall・ラッセル・老子の系譜から**ユーザーの怠惰そのものを肯定する**動的応答を返し、罪悪感ループから人々を解放する。SNS は IP の入口・コミュニティ装置であり、本業は IP の育成（物販・ライセンス・コラボ・出版）である。
